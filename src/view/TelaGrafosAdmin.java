...
public class TelaGrafosAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(Link1);
        Link1.setBounds(230, 290, 358, 25);
        ...
        jButton1.setBounds(710, 120, 70, 20);
        ...
        jPanel1.add(Link2);
        Link2.setBounds(230, 340, 358, 25);
        ...
        TitleProgramacao.setBounds(350, 100, 108, 41);
        ...
        ButtonInserirConteudo.setBounds(310, 540, 180, 30);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaGrafosAdmin().setVisible(true);
            }
        });
    }
